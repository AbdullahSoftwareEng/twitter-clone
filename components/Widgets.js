    ...
    <div className="xl:w-[600px] hidden lg:inline ml-8 space-y-5">
        ...
        <div className="text-gray-700 space-y-3 bg-gray-100 pt-2 rounded-xl w-[90%] xl:w-[75%] sticky top-16">
            ...
            {randomUsersResults.slice(0,randomUserNum).map((randomUser) =>(
                <div key={randomUser.login.username} className="flex items-center px-4 py-2 hover:bg-gray-200 cursor-pointer">
            ...
            <button 
                ...
                onClick={() => setRandomUserNum((prev => prev + 3 ))}>
                    Show more
            </button>
        </div>            
